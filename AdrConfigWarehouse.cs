...
namespace Klyte.Addresses
{
    ...
    {
        public const string CONFIG_FILENAME = "KlyteAddresses";
        ...
        public enum ConfigIndex : uint
        {
            ...
            TINY_ROAD_PREFIX_FILENAME              = 0x01 | STREET_TYPE_NAMING_CONFIG | TYPE_STRING,
            SMALL_ROAD_PREFIX_FILENAME             = 0x02 | STREET_TYPE_NAMING_CONFIG | TYPE_STRING,
            HEAVY_SMALL_ROAD_PREFIX_FILENAME       = 0x03 | STREET_TYPE_NAMING_CONFIG | TYPE_STRING,
            MEDIUM_ROAD_PREFIX_FILENAME            = 0x04 | STREET_TYPE_NAMING_CONFIG | TYPE_STRING,
            LARGE_ROAD_PREFIX_FILENAME             = 0x05 | STREET_TYPE_NAMING_CONFIG | TYPE_STRING,
            HYPER_ROAD_PREFIX_FILENAME             = 0x06 | STREET_TYPE_NAMING_CONFIG | TYPE_STRING,
            HIGHWAY_PREFIX_FILENAME                = 0x07 | STREET_TYPE_NAMING_CONFIG | TYPE_STRING,
        }
